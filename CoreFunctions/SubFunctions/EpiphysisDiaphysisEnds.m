function [Zdiaph,Zepi,or] = EpiphysisDiaphysisEnds(Z, Area)
%EpiphysisDiaphysisEnds(Z,AREA)
% Find the altitudes Z where to separate the diaphysis from the metaphysis, 
% and the metaphysis from the epiphysis
%  Create a fit of the surface area :
...
Zdiaph = [ZStartDiaphysis;ZendDiaphysis];

ZStartEpiphysis = fitresult.b1 - 1.5*or*fitresult.c1;

Zepi = ZStartEpiphysis;
